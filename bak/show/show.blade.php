                                ...
                                <div class="cart-hover">
                                    <div class="select-items">
                                        <table>
                                            <tbody>
                                                <tr>
                                                    <td class="si-pic"><img src="cart/img/select-product-1.jpg" alt=""></td>
                                                    <td class="si-text">
                                                ...
                                                <tr>
                                                    <td class="si-pic"><img src="cart/img/select-product-2.jpg" alt=""></td>
                                                    <td class="si-text">
                                                        <div class="product-selected">
                                                            <p>₫60.00 x 1</p>
                                                            <h6>Kabino Bedside Table</h6>
                    ...
                    <div class="product-list">
                        ...
                        @foreach($data as $dt)
                                        ...
                                        <div class="product-item">
                                                     <div class="pi-pic">
                                                                 ...
                                                                 <ul>
                                                                           ...
                                                                           <li class="quick-view"><a href="{!! URL ::route('giohang',$dt->id)!!}">+ Add Cart</a></li>
                            ...
                            <!-- <div class="col-lg-4 col-sm-6">
                                <div class="product-item">
                                    <div class="pi-pic">
                                        <img src="cart/img/products/product-2.jpg" alt="">
                                        <div class="icon">
                                            <i class="icon_heart_alt"></i>
                                        </div>
                                        <ul>
                            ...
                            <!-- <div class="col-lg-4 col-sm-6">
                                <div class="product-item">
                                    <div class="pi-pic">
                                        <img src="cart/img/products/product-3.jpg" alt="">
                                        <div class="icon">
                                            <i class="icon_heart_alt"></i>
                                        </div>
                                        <ul>
